...
temaki_skin.image.attach(io: File.open('public/assets/temaki.jpg'), filename: "temaki.jpg")

temaki_california = Product.create(name: "California", category: temakis, price: 17.90, description: "Salmão, pepino e Kani Kama.")
temaki_california.image.attach(io: File.open('public/assets/temaki.jpg'), filename: "temaki.jpg")
...
temaki_salmon_philadelphia.image.attach(io: File.open('public/assets/temaki.jpg'), filename: "temaki.jpg")

temaki_hot = Product.create(name: "Hot", category: temakis, price: 18.90, description: "Temaki de salmão empanado e frito.")
temaki_hot.image.attach(io: File.open('public/assets/temaki.jpg'), filename: "temaki.jpg")
...
poke_aloha.image.attach(io: File.open('public/assets/poke.jpg'), filename: "poke.jpg")
...
poke_oahu.image.attach(io: File.open('public/assets/poke.jpg'), filename: "poke.jpg")
...
poke_hawaii.image.attach(io: File.open('public/assets/poke.jpg'), filename: "poke.jpg")
...
poke_hilo.image.attach(io: File.open('public/assets/poke.jpg'), filename: "poke.jpg")
...
poke_kapaa.image.attach(io: File.open('public/assets/poke.jpg'), filename: "poke.jpg")
...
entrada_ceviche_frutos_do_mar.image.attach(io: File.open('public/assets/ceviche.jpg'), filename: "ceviche.jpg")

entrada_sunomono = Product.create(name: "Sunomono", category: entradas, price: 14.99, description: "Salada de pepinos agridoce.")
entrada_sunomono.image.attach(io: File.open('public/assets/sunomono.jpg'), filename: "sunomono.jpg")

entrada_hotroll = Product.create(name: "Hot Roll", category: entradas, price: 27.99, description: "12 unidades.")
entrada_hotroll.image.attach(io: File.open('public/assets/hotroll.jpg'), filename: "hotroll.jpg")

entrada_sashimi = Product.create(name: "Sashimi", category: entradas, price: 16.90, description: "8 unidades.")
entrada_sashimi.image.attach(io: File.open('public/assets/sashimi.jpg'), filename: "sashimi.jpg")
